...
const Form = () => {
  ...
  const boardWidth = 183;
  const boardLength = 363;
  const boardSurface = boardLength * boardWidth;
    ...
    <div className="global-form-div">
      <form className="global-form">
        <div className="inputs">
          ...
          >
            <p style={{ color: "red" }}>
              <b>Տվյալների ներմուծման տեսակը դրական թվեր !!!</b>
            </p>
            <p>
              Առավելագույն երկարություն <b>183սմ</b>
            </p>
            <p>
              Առավելագույն լայնություն <b>363սմ</b>
            </p>
            <p>
              Առավելագույն քանակ <b>500</b>{" "}
            </p>
          </Modal>
        </div>
